...
TOOLS: list[dict[str, Any]] = [
    ...
    # Каждая комната — отдельный room_id + room_key. Owner создаёт комнату,
    # делится room_key с агентами (или хранит сам в кабинете). Все agents
    # одного owner-а могут joining одной комнатой если им передать room_key.
    {
        "name": "room_create",
        "description": (
