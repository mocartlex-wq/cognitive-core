...
_CHAT_BUTTON_TAG = (
    ...
    "var a=document.createElement('a');a.href='/static/chat-prototype.html?v='+encodeURIComponent('" + str(int(time.time())) + "');a.className='topbar-chat';"
    "a.title='Веб-приложение';a.innerHTML='\\uD83D\\uDCF1 \\u041F\\u0440\\u0438\\u043B\\u043E\\u0436\\u0435\\u043D\\u0438\\u0435';"
