...
Один связный отчёт в конце: что сделано, чем это проверено, что осталось и
почему. Числа «до и после», а не «стало лучше». Обнаруженные по пути изъяны
называй прямо, включая свои собственные.
