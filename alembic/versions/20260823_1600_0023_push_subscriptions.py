...
Переномерована при сведении веток 05.09: две ветки независимо взяли номер
0022 от 0021, и `alembic upgrade head` упал бы на двух головах. Обе были
не применены нигде (прод стоял на 0021), поэтому цепочку выпрямили, а не
склеили merge-ревизией.
